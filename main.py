...
from ui import btnManager as btn
from ui.pages import soundboard, upload, settings
...
class MainApp(ctk.CTk):
    def __init__(self):
        ...
        self.title("LimeFX")
        self.iconbitmap("./assets/logo/icon.ico")
        ...
        logo_img = ctk.CTkImage(
            light_image=Image.open("./assets/logo/icon-w-text.png"),
            dark_image=Image.open("./assets/logo/icon-w-text.png"),
            size=(128, 128)
        )
    ...
    def show_soundboard(self):
        if self.current_page == "soundboard":
            return
        self.current_page = "soundboard"
        self.clear()
